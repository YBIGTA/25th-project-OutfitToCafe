# Generated by Django 3.2 on 2024-08-19 05:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_pic', models.FileField(blank=True, default='user_pics/default_profile_pic.jpg', null=True, upload_to=coplate.models.person_pic_upload_to)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image1', models.FileField(upload_to=coplate.models.cafe_pic_upload_to)),
                ('image1_url', models.URLField()),
                ('image2', models.FileField(blank=True, upload_to=coplate.models.cafe_pic_upload_to)),
                ('image2_url', models.URLField(blank=True)),
                ('image3', models.FileField(blank=True, upload_to=coplate.models.cafe_pic_upload_to)),
                ('image3_url', models.URLField(blank=True)),
                ('image4', models.FileField(blank=True, upload_to=coplate.models.cafe_pic_upload_to)),
                ('image4_url', models.URLField(blank=True)),
                ('image5', models.FileField(blank=True, upload_to=coplate.models.cafe_pic_upload_to)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('style_keywords', models.ManyToManyField(related_name='dripshots', to='coplate.StyleKeyword')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
        ...
        migrations.AddField(
            model_name='cafe',
            name='cafe_keywords',
            field=models.ManyToManyField(blank=True, related_name='cafes', to='coplate.CafeKeyword'),
        ),
        migrations.AddField(
            model_name='cafe',
            name='style_keywords',
            field=models.ManyToManyField(related_name='cafes', to='coplate.StyleKeyword'),
        ),
        migrations.AddField(
            model_name='user',
            name='style_keywords',
            field=models.ManyToManyField(related_name='users', to='coplate.StyleKeyword'),
        ),
        migrations.AddField(
            model_name='user',
