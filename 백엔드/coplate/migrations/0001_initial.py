# Generated by Django 3.2 on 2024-08-20 12:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image1', models.ImageField(blank=True, upload_to='cafe')),
                ('image2', models.ImageField(blank=True, upload_to='cafe')),
                ('image3', models.ImageField(blank=True, upload_to='cafe')),
                ('image4', models.ImageField(blank=True, upload_to='cafe')),
                ('image5', models.ImageField(blank=True, upload_to='cafe')),
        ...
        migrations.CreateModel(
            name='UserStyleKeyword',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('style_keyword', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='coplate.stylekeyword')),
