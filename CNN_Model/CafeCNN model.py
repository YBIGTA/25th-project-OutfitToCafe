...
# This is for the second json file we are going to make
...
top_class_probabilities = class_probabilities.copy()
...
# Creating a different json file that only contains the top 3 classes! 
...
top_json_output_path = '/Users/dennycheong/24 여름방학/YBIGTA/신입플/CNN_Model/Classification_Results/top_classification_results.json'
